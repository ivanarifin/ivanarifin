...
> Mechanical Engineer from **ITS** who made a full pivot into software — and never looked back.

- 🔧 Wrote a thesis on **renewable energy gasification**. Now I build apps.
- 🎓 **Hacktiv8** Fullstack Javascript Immersive — graduated with honor (90.3/100)
- 💼 Currently **Frontend Developer @ Loyal.id** — shipping React Native apps to real users
- 🧠 The engineer brain helps: analytical thinking + efficient debugging
...
| App | Platform |
|-----|----------|
| Pundis Botani | Android / iOS |
| ABB Star Reward | Android / iOS |
| My Artos | Android / iOS |
| Resinda Privilege Member Card | Android / iOS |
| Loyalid Merchant | Android / iOS |
| MG Friends | Android / iOS |
| Eastvara | Android / iOS |
| SKA Family | Android / iOS |
| Sahabat Max | Android / iOS |
| ITC Privilege | Android / iOS |
